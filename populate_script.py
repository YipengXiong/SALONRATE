...
def populate_saloninfo():
    ...
    with open("salon_info.json", "r") as f:
        ...
        for salon_info in salon_info_list:
            ...
            s = Salon(salon_name=salon_name, rate=salon_rate, salon_address=salon_address, image=salon_image,
                      salon_avg_price=salon_price, salon_busy=salon_busy, phone=salon_phone, open_time=salon_time)
            s.save()
        f.close()
    ...
    with open("details.json", "r") as f:
        ...
        for salon_detail in salon_detail_list:
            ...
            for name in detail[0]:
                ...
                s = Service(salon_id=salon_object, service_name=service_name, service_price=service_price,
                            rate=service_rate, service_type=service_type)
                s.save()
            salon_id = salon_id + 1
        f.close()
        ...
        for salon_detail in salon_detail_list:
            ...
            for comment in comments:
                ...
                c = Comment(username=user, salon_or_service_id=id, type=comment_type, comment=comment_content,
                            ...
                            tag_environ=randomBool(), tag_service=randomBool(), tag_cost=randomBool(),
                            tag_skill=randomBool(), tag_attitude=randomBool(), )
                c.save()
        f.close()
