...
class salonratemodeltest(TestCase):
    def setUp(self) -> None:
        ...
        service_5 = Service.objects.create(service_name="Beauty Care", salon_id=salon, service_type=4,
                                           service_price=58.8)
        ...
        service_7 = Service.objects.create(service_name="Eyebrow Care", salon_id=salon, service_type=4,
                                           service_price=28.8)
        ...
        service1_1 = Service.objects.create(service_name="Beauty Care", salon_id=salon1, service_type=4,
                                            service_price=50)
        ...
        service1_3 = Service.objects.create(service_name="Eyebrow Care", salon_id=salon1, service_type=4,
                                            service_price=20)
